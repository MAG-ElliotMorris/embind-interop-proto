...
class ApiVersion;
class BulkUpsertPointOfInterestDto;
...
/// <summary>
/// Bulk Point Of Interest Upsert DTO
/// </summary>
class BulkUpsertPointOfInterestDto : public csp::services::DtoBase
{
public:
	BulkUpsertPointOfInterestDto();
	virtual ~BulkUpsertPointOfInterestDto();
