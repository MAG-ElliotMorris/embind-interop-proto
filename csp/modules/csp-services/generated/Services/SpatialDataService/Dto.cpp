...
utility::string_t BulkUpsertPointOfInterestDto::ToJson() const
{
	rapidjson::Document JsonDoc(rapidjson::kObjectType);
...
void BulkUpsertPointOfInterestDto::FromJson(const utility::string_t& Val)
{
	rapidjson::Document JsonDoc;
...
utility::string_t BulkUpsertPointOfInterestDto::GetId() const
{
	return m_Id.value();
}

bool BulkUpsertPointOfInterestDto::HasId() const
{
	return m_Id.has_value();
}
void BulkUpsertPointOfInterestDto::SetId(const utility::string_t& Value)
{
	m_Id = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetCreatedBy() const
{
	return m_CreatedBy.value();
}

bool BulkUpsertPointOfInterestDto::HasCreatedBy() const
{
	return m_CreatedBy.has_value();
}
utility::string_t BulkUpsertPointOfInterestDto::GetUpdatedBy() const
{
	return m_UpdatedBy.value();
}

bool BulkUpsertPointOfInterestDto::HasUpdatedBy() const
{
	return m_UpdatedBy.has_value();
}
utility::string_t BulkUpsertPointOfInterestDto::GetCreatedAt() const
{
	return m_CreatedAt.value();
}

bool BulkUpsertPointOfInterestDto::HasCreatedAt() const
{
	return m_CreatedAt.has_value();
}
utility::string_t BulkUpsertPointOfInterestDto::GetUpdatedAt() const
{
	return m_UpdatedAt.value();
}

bool BulkUpsertPointOfInterestDto::HasUpdatedAt() const
{
	return m_UpdatedAt.has_value();
}
const std::vector<std::shared_ptr<LocalizedString>>& BulkUpsertPointOfInterestDto::GetTitle() const
{
	return m_Title.value();
}

bool BulkUpsertPointOfInterestDto::HasTitle() const
{
	return m_Title.has_value();
}
void BulkUpsertPointOfInterestDto::SetTitle(const std::vector<std::shared_ptr<LocalizedString>>& Value)
{
	m_Title = Value;
}
const std::vector<std::shared_ptr<LocalizedString>>& BulkUpsertPointOfInterestDto::GetDescription() const
{
	return m_Description.value();
}

bool BulkUpsertPointOfInterestDto::HasDescription() const
{
	return m_Description.has_value();
}
void BulkUpsertPointOfInterestDto::SetDescription(const std::vector<std::shared_ptr<LocalizedString>>& Value)
{
	m_Description = Value;
}
const std::map<utility::string_t, std::vector<std::shared_ptr<LocalizedString>>>& BulkUpsertPointOfInterestDto::GetUiStrings() const
{
	return m_UiStrings.value();
}

bool BulkUpsertPointOfInterestDto::HasUiStrings() const
{
	return m_UiStrings.has_value();
}
void BulkUpsertPointOfInterestDto::SetUiStrings(const std::map<utility::string_t, std::vector<std::shared_ptr<LocalizedString>>>& Value)
{
	m_UiStrings = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetType() const
{
	return m_Type.value();
}

bool BulkUpsertPointOfInterestDto::HasType() const
{
	return m_Type.has_value();
}
void BulkUpsertPointOfInterestDto::SetType(const utility::string_t& Value)
{
	m_Type = Value;
}
int32_t BulkUpsertPointOfInterestDto::GetZoomLevel() const
{
	return m_ZoomLevel.value();
}

bool BulkUpsertPointOfInterestDto::HasZoomLevel() const
{
	return m_ZoomLevel.has_value();
}
void BulkUpsertPointOfInterestDto::SetZoomLevel(int32_t Value)
{
	m_ZoomLevel = Value;
}
const std::vector<utility::string_t>& BulkUpsertPointOfInterestDto::GetTags() const
{
	return m_Tags.value();
}

bool BulkUpsertPointOfInterestDto::HasTags() const
{
	return m_Tags.has_value();
}
void BulkUpsertPointOfInterestDto::SetTags(const std::vector<utility::string_t>& Value)
{
	m_Tags = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetThumbnailUri() const
{
	return m_ThumbnailUri.value();
}

bool BulkUpsertPointOfInterestDto::HasThumbnailUri() const
{
	return m_ThumbnailUri.has_value();
}
void BulkUpsertPointOfInterestDto::SetThumbnailUri(const utility::string_t& Value)
{
	m_ThumbnailUri = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetThumbnailMimeType() const
{
	return m_ThumbnailMimeType.value();
}

bool BulkUpsertPointOfInterestDto::HasThumbnailMimeType() const
{
	return m_ThumbnailMimeType.has_value();
}
void BulkUpsertPointOfInterestDto::SetThumbnailMimeType(const utility::string_t& Value)
{
	m_ThumbnailMimeType = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetName() const
{
	return m_Name.value();
}

bool BulkUpsertPointOfInterestDto::HasName() const
{
	return m_Name.has_value();
}
void BulkUpsertPointOfInterestDto::SetName(const utility::string_t& Value)
{
	m_Name = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetOwner() const
{
	return m_Owner.value();
}

bool BulkUpsertPointOfInterestDto::HasOwner() const
{
	return m_Owner.has_value();
}
void BulkUpsertPointOfInterestDto::SetOwner(const utility::string_t& Value)
{
	m_Owner = Value;
}
std::shared_ptr<GeoCoord> BulkUpsertPointOfInterestDto::GetLocation() const
{
	return m_Location.value();
}

bool BulkUpsertPointOfInterestDto::HasLocation() const
{
	return m_Location.has_value();
}
void BulkUpsertPointOfInterestDto::SetLocation(const std::shared_ptr<GeoCoord>& Value)
{
	m_Location = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetEventId() const
{
	return m_EventId.value();
}

bool BulkUpsertPointOfInterestDto::HasEventId() const
{
	return m_EventId.has_value();
}
void BulkUpsertPointOfInterestDto::SetEventId(const utility::string_t& Value)
{
	m_EventId = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetParentId() const
{
	return m_ParentId.value();
}

bool BulkUpsertPointOfInterestDto::HasParentId() const
{
	return m_ParentId.has_value();
}
void BulkUpsertPointOfInterestDto::SetParentId(const utility::string_t& Value)
{
	m_ParentId = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetGroupId() const
{
	return m_GroupId.value();
}

bool BulkUpsertPointOfInterestDto::HasGroupId() const
{
	return m_GroupId.has_value();
}
void BulkUpsertPointOfInterestDto::SetGroupId(const utility::string_t& Value)
{
	m_GroupId = Value;
}
bool BulkUpsertPointOfInterestDto::GetHidden() const
{
	return m_Hidden.value();
}

bool BulkUpsertPointOfInterestDto::HasHidden() const
{
	return m_Hidden.has_value();
}
void BulkUpsertPointOfInterestDto::SetHidden(const bool& Value)
{
	m_Hidden = Value;
}
const std::vector<std::shared_ptr<GeoCoord>>& BulkUpsertPointOfInterestDto::GetGeofence() const
{
	return m_Geofence.value();
}

bool BulkUpsertPointOfInterestDto::HasGeofence() const
{
	return m_Geofence.has_value();
}
void BulkUpsertPointOfInterestDto::SetGeofence(const std::vector<std::shared_ptr<GeoCoord>>& Value)
{
	m_Geofence = Value;
}
bool BulkUpsertPointOfInterestDto::GetPrivate() const
{
	return m_Private.value();
}

bool BulkUpsertPointOfInterestDto::HasPrivate() const
{
	return m_Private.has_value();
}
void BulkUpsertPointOfInterestDto::SetPrivate(const bool& Value)
{
	m_Private = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetReferenceLookup() const
{
	return m_ReferenceLookup.value();
}

bool BulkUpsertPointOfInterestDto::HasReferenceLookup() const
{
	return m_ReferenceLookup.has_value();
}
void BulkUpsertPointOfInterestDto::SetReferenceLookup(const utility::string_t& Value)
{
	m_ReferenceLookup = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetPrototypeId() const
{
	return m_PrototypeId.value();
}

bool BulkUpsertPointOfInterestDto::HasPrototypeId() const
{
	return m_PrototypeId.has_value();
}
void BulkUpsertPointOfInterestDto::SetPrototypeId(const utility::string_t& Value)
{
	m_PrototypeId = Value;
}
utility::string_t BulkUpsertPointOfInterestDto::GetPrototypeName() const
{
	return m_PrototypeName.value();
}

bool BulkUpsertPointOfInterestDto::HasPrototypeName() const
{
	return m_PrototypeName.has_value();
}
void BulkUpsertPointOfInterestDto::SetPrototypeName(const utility::string_t& Value)
{
	m_PrototypeName = Value;
}
bool BulkUpsertPointOfInterestDto::GetRequireAction() const
{
	return m_RequireAction.value();
}

bool BulkUpsertPointOfInterestDto::HasRequireAction() const
{
	return m_RequireAction.has_value();
}
void BulkUpsertPointOfInterestDto::SetRequireAction(const bool& Value)
{
	m_RequireAction = Value;
}
bool BulkUpsertPointOfInterestDto::GetIsDebug() const
{
	return m_IsDebug.value();
}

bool BulkUpsertPointOfInterestDto::HasIsDebug() const
{
	return m_IsDebug.has_value();
}
void BulkUpsertPointOfInterestDto::SetIsDebug(const bool& Value)
{
	m_IsDebug = Value;
}
float BulkUpsertPointOfInterestDto::GetOrientation() const
{
	return m_Orientation.value();
}

bool BulkUpsertPointOfInterestDto::HasOrientation() const
{
	return m_Orientation.has_value();
}
void BulkUpsertPointOfInterestDto::SetOrientation(float Value)
{
	m_Orientation = Value;
}
std::shared_ptr<Transform> BulkUpsertPointOfInterestDto::GetPrototypeTransform() const
{
	return m_PrototypeTransform.value();
}

bool BulkUpsertPointOfInterestDto::HasPrototypeTransform() const
{
	return m_PrototypeTransform.has_value();
}
void BulkUpsertPointOfInterestDto::SetPrototypeTransform(const std::shared_ptr<Transform>& Value)
{
