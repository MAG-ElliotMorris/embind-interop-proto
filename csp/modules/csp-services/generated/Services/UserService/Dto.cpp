...
DefaultSessionSettingsDto::DefaultSessionSettingsDto()
{
}
DefaultSessionSettingsDto::~DefaultSessionSettingsDto()
{
...
utility::string_t DefaultSessionSettingsDto::ToJson() const
{
	rapidjson::Document JsonDoc(rapidjson::kObjectType);
	...
	if (m_ApplicationSettingsContexts.has_value())
	{
		rapidjson::Value ApplicationSettingsContextsValue(TypeToJsonValue(m_ApplicationSettingsContexts, JsonDoc.GetAllocator()));
		JsonDoc.AddMember("applicationSettingsContexts", ApplicationSettingsContextsValue, JsonDoc.GetAllocator());
	}

	if (m_UserSettingsContexts.has_value())
	{
		rapidjson::Value UserSettingsContextsValue(TypeToJsonValue(m_UserSettingsContexts, JsonDoc.GetAllocator()));
		JsonDoc.AddMember("userSettingsContexts", UserSettingsContextsValue, JsonDoc.GetAllocator());
	}
...
void DefaultSessionSettingsDto::FromJson(const utility::string_t& Val)
{
	rapidjson::Document JsonDoc;
	...
	if (JsonDoc.HasMember("applicationSettingsContexts"))
	{
		const rapidjson::Value& ApplicationSettingsContextsValue = JsonDoc["applicationSettingsContexts"];

		if (ApplicationSettingsContextsValue != rapidjson::Type::kNullType)
		{
			JsonValueToType(ApplicationSettingsContextsValue, m_ApplicationSettingsContexts);
		}
	}

	if (JsonDoc.HasMember("userSettingsContexts"))
	{
		const rapidjson::Value& UserSettingsContextsValue = JsonDoc["userSettingsContexts"];

		if (UserSettingsContextsValue != rapidjson::Type::kNullType)
		{
			JsonValueToType(UserSettingsContextsValue, m_UserSettingsContexts);
		}
	}
}


utility::string_t DefaultSessionSettingsDto::GetApplicationName() const
{
	return m_ApplicationName.value();
}

bool DefaultSessionSettingsDto::HasApplicationName() const
{
	return m_ApplicationName.has_value();
}
void DefaultSessionSettingsDto::SetApplicationName(const utility::string_t& Value)
{
	m_ApplicationName = Value;
}
const std::vector<utility::string_t>& DefaultSessionSettingsDto::GetApplicationSettingsContexts() const
{
	return m_ApplicationSettingsContexts.value();
}

bool DefaultSessionSettingsDto::HasApplicationSettingsContexts() const
{
	return m_ApplicationSettingsContexts.has_value();
}
void DefaultSessionSettingsDto::SetApplicationSettingsContexts(const std::vector<utility::string_t>& Value)
{
	m_ApplicationSettingsContexts = Value;
}
const std::vector<utility::string_t>& DefaultSessionSettingsDto::GetUserSettingsContexts() const
{
	return m_UserSettingsContexts.value();
}

bool DefaultSessionSettingsDto::HasUserSettingsContexts() const
{
	return m_UserSettingsContexts.has_value();
}
void DefaultSessionSettingsDto::SetUserSettingsContexts(const std::vector<utility::string_t>& Value)
{
	m_UserSettingsContexts = Value;
}
...
void GroupDto::SetOrganizationId(const utility::string_t& Value)
{
...
utility::string_t LoginGuestRequest::ToJson() const
{
	rapidjson::Document JsonDoc(rapidjson::kObjectType);
	...
	if (m_TokenOptions.has_value())
	{
		rapidjson::Value TokenOptionsValue(TypeToJsonValue(m_TokenOptions, JsonDoc.GetAllocator()));
		JsonDoc.AddMember("tokenOptions", TokenOptionsValue, JsonDoc.GetAllocator());
	}
...
void LoginGuestRequest::FromJson(const utility::string_t& Val)
{
	rapidjson::Document JsonDoc;
	...
	if (JsonDoc.HasMember("tokenOptions"))
	{
		const rapidjson::Value& TokenOptionsValue = JsonDoc["tokenOptions"];

		if (TokenOptionsValue != rapidjson::Type::kNullType)
		{
			JsonValueToType(TokenOptionsValue, m_TokenOptions);
		}
		else
		{
			CSP_LOG_ERROR_MSG("Error: Non-nullable member tokenOptions is null!");
		}
	}
}


utility::string_t LoginGuestRequest::GetTenant() const
{
	return m_Tenant.value();
}

bool LoginGuestRequest::HasTenant() const
{
	return m_Tenant.has_value();
}
void LoginGuestRequest::SetTenant(const utility::string_t& Value)
{
	m_Tenant = Value;
}
utility::string_t LoginGuestRequest::GetDeviceId() const
{
	return m_DeviceId.value();
}

bool LoginGuestRequest::HasDeviceId() const
{
	return m_DeviceId.has_value();
}
void LoginGuestRequest::SetDeviceId(const utility::string_t& Value)
{
	m_DeviceId = Value;
}
bool LoginGuestRequest::GetVerifiedAgeEighteen() const
{
	return m_VerifiedAgeEighteen.value();
}

bool LoginGuestRequest::HasVerifiedAgeEighteen() const
{
	return m_VerifiedAgeEighteen.has_value();
}
void LoginGuestRequest::SetVerifiedAgeEighteen(const bool& Value)
{
	m_VerifiedAgeEighteen = Value;
}
std::shared_ptr<TokenOptions> LoginGuestRequest::GetTokenOptions() const
{
	return m_TokenOptions.value();
}

bool LoginGuestRequest::HasTokenOptions() const
{
	return m_TokenOptions.has_value();
}
void LoginGuestRequest::SetTokenOptions(const std::shared_ptr<TokenOptions>& Value)
{
	m_TokenOptions = Value;
}
...
std::shared_ptr<TokenOptions> LoginRequest::GetTokenOptions() const
{
	return m_TokenOptions.value();
}

bool LoginRequest::HasTokenOptions() const
{
	return m_TokenOptions.has_value();
}
void LoginRequest::SetTokenOptions(const std::shared_ptr<TokenOptions>& Value)
{
	m_TokenOptions = Value;
}
...
std::shared_ptr<TokenOptions> LoginSocialRequest::GetTokenOptions() const
{
	return m_TokenOptions.value();
}

bool LoginSocialRequest::HasTokenOptions() const
{
	return m_TokenOptions.has_value();
}
void LoginSocialRequest::SetTokenOptions(const std::shared_ptr<TokenOptions>& Value)
{
	m_TokenOptions = Value;
}
...
std::shared_ptr<TokenOptions> RefreshRequest::GetTokenOptions() const
{
	return m_TokenOptions.value();
}

bool RefreshRequest::HasTokenOptions() const
{
	return m_TokenOptions.has_value();
}
void RefreshRequest::SetTokenOptions(const std::shared_ptr<TokenOptions>& Value)
{
	m_TokenOptions = Value;
}
...
utility::string_t TenantDto::ToJson() const
{
	...
	if (m_DefaultSessionSettings.has_value())
	{
		rapidjson::Value DefaultSessionSettingsValue(TypeToJsonValue(m_DefaultSessionSettings, JsonDoc.GetAllocator()));
...
void TenantDto::FromJson(const utility::string_t& Val)
{
	...
	if (JsonDoc.HasMember("defaultSessionSettings"))
	{
		const rapidjson::Value& DefaultSessionSettingsValue = JsonDoc["defaultSessionSettings"];

		if (DefaultSessionSettingsValue != rapidjson::Type::kNullType)
		{
			JsonValueToType(DefaultSessionSettingsValue, m_DefaultSessionSettings);
		}
		else
		{
...
std::shared_ptr<DefaultSessionSettingsDto> TenantDto::GetDefaultSessionSettings() const
{
	return m_DefaultSessionSettings.value();
}

bool TenantDto::HasDefaultSessionSettings() const
{
	return m_DefaultSessionSettings.has_value();
}
void TenantDto::SetDefaultSessionSettings(const std::shared_ptr<DefaultSessionSettingsDto>& Value)
{
...
utility::string_t TokenOptions::ToJson() const
{
	rapidjson::Document JsonDoc(rapidjson::kObjectType);


	if (m_ExpiryLength.has_value())
	{
		rapidjson::Value ExpiryLengthValue(TypeToJsonValue(m_ExpiryLength, JsonDoc.GetAllocator()));
		JsonDoc.AddMember("expiryLength", ExpiryLengthValue, JsonDoc.GetAllocator());
	}

	if (m_RefreshTokenExpiryLength.has_value())
	{
		rapidjson::Value RefreshTokenExpiryLengthValue(TypeToJsonValue(m_RefreshTokenExpiryLength, JsonDoc.GetAllocator()));
		JsonDoc.AddMember("refreshTokenExpiryLength", RefreshTokenExpiryLengthValue, JsonDoc.GetAllocator());
	}
...
void TokenOptions::FromJson(const utility::string_t& Val)
{
	rapidjson::Document JsonDoc;
	...
	{
		const rapidjson::Value& ExpiryLengthValue = JsonDoc["expiryLength"];

		if (ExpiryLengthValue != rapidjson::Type::kNullType)
		{
			JsonValueToType(ExpiryLengthValue, m_ExpiryLength);
		}
	}

	if (JsonDoc.HasMember("refreshTokenExpiryLength"))
	{
		const rapidjson::Value& RefreshTokenExpiryLengthValue = JsonDoc["refreshTokenExpiryLength"];

		if (RefreshTokenExpiryLengthValue != rapidjson::Type::kNullType)
		{
			JsonValueToType(RefreshTokenExpiryLengthValue, m_RefreshTokenExpiryLength);
		}
	}
}


utility::string_t TokenOptions::GetExpiryLength() const
{
	return m_ExpiryLength.value();
}

bool TokenOptions::HasExpiryLength() const
{
	return m_ExpiryLength.has_value();
}
void TokenOptions::SetExpiryLength(const utility::string_t& Value)
{
	m_ExpiryLength = Value;
}
utility::string_t TokenOptions::GetRefreshTokenExpiryLength() const
{
	return m_RefreshTokenExpiryLength.value();
}

bool TokenOptions::HasRefreshTokenExpiryLength() const
{
	return m_RefreshTokenExpiryLength.has_value();
}
void TokenOptions::SetRefreshTokenExpiryLength(const utility::string_t& Value)
{
	m_RefreshTokenExpiryLength = Value;
}
